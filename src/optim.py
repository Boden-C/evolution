"""Deprecated shim: import from `evolution.src.runtime.optim` instead.

Kept to avoid breaking imports while the package structure is being adopted.
"""

from .runtime.optim import *  # noqa: F401,F403
